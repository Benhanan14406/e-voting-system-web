...
from .views import ElectionListView, ElectionCreateView, ElectionOpenView, ElectionCloseView, ElectionDeleteView, CandidateListView, CandidateCreateView, CandidateDeleteView
...
urlpatterns = [
    ...
    path("elections/<uuid:pk>/delete/", ElectionDeleteView.as_view(), name="election_delete"),
